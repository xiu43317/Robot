...
class PCA9685:
    ...
    def __init__(self, addr = 0x41, freq=50):
        self.addr = addr
    ...
    # ex: count_dic = {1:1024, 2:2048, 15:999} , count : 0 ( 0% ) ~ 4096 ( 100% )
    #
    ...
    def showInfo(self): 
        ...
        for i in range(16):
            print "ch:%2d duty_cycle:%f count:%f %s" % ( i , self.getChDuty(i) , self.getValChOff(i) , 'on' if (self.isChOn(i)) else 'off')
